...
\begin{figure}[htbp]
	...
	\caption{Attribute to association end refactoring in EMF Refactor. Taken from \cite{arendt09refactoring}.}
...
% Engels et al. envisage a means for specifying model transformations that preserve the semantics of input models in the result models. The approach is demonstrated for transforming from UML to TAAL, a simple object-oriented programming language. 
