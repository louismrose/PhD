...
\contentsline {lstlisting}{\numberline {5.3}Specifying a containment reference with HUTN.}{101}{lstlisting.5.3}
...
\contentsline {lstlisting}{\numberline {5.9}Transforming Nodes to PackageObjects with ETL.}{105}{lstlisting.5.9}
\contentsline {lstlisting}{\numberline {5.10}A constraint (in EVL) to check that all identifiers are unique.}{106}{lstlisting.5.10}
\contentsline {lstlisting}{\numberline {5.11}Higher-order transformation with EGL}{107}{lstlisting.5.11}
\contentsline {lstlisting}{\numberline {5.12}The M2M transformation generated for the Families metamodel}{108}{lstlisting.5.12}
...
\contentsline {lstlisting}{\numberline {5.18}Petri nets model migration in COPE}{117}{lstlisting.5.18}
...
\contentsline {lstlisting}{\numberline {6.14}Migrating ActivityGraphs}{194}{lstlisting.6.14}
...
\contentsline {lstlisting}{\numberline {6.19}Migrating Partitions without ObjectFlowStates}{196}{lstlisting.6.19}
