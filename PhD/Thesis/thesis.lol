\contentsline {lstlisting}{\numberline {2.1}M2M transformation in ETL}{20}{lstlisting.2.1}
\contentsline {lstlisting}{\numberline {2.2}M2T transformation in EGL}{21}{lstlisting.2.2}
\contentsline {lstlisting}{\numberline {2.3}T2M transformation in EMFText}{22}{lstlisting.2.3}
...
\contentsline {lstlisting}{\numberline {5.2}A constraint (in EVL) to check that only concrete metamodel types are instantiated.}{109}{lstlisting.5.2}
\contentsline {lstlisting}{\numberline {5.3}XMI for the family model in Figure\nobreakspace {}\ref {fig:families_model_repeated}}{111}{lstlisting.5.3}
...
\contentsline {lstlisting}{\numberline {5.7}Specifying a simple reference with HUTN}{116}{lstlisting.5.7}
\contentsline {lstlisting}{\numberline {5.8}Keywords and adjectives in HUTN}{116}{lstlisting.5.8}
\contentsline {lstlisting}{\numberline {5.9}A reference block in HUTN}{117}{lstlisting.5.9}
\contentsline {lstlisting}{\numberline {5.10}An infix reference in HUTN}{117}{lstlisting.5.10}
\contentsline {lstlisting}{\numberline {5.11}An extract of the Epsilon HUTN grammar definition in EBNF}{121}{lstlisting.5.11}
\contentsline {lstlisting}{\numberline {5.12}Transforming Nodes to PackageObjects with ETL.}{121}{lstlisting.5.12}
\contentsline {lstlisting}{\numberline {5.13}A constraint (in EVL) to check that all identifiers are unique.}{122}{lstlisting.5.13}
\contentsline {lstlisting}{\numberline {5.14}Higher-order transformation with EGL}{123}{lstlisting.5.14}
\contentsline {lstlisting}{\numberline {5.15}The M2M transformation generated for the Families metamodel}{124}{lstlisting.5.15}
\contentsline {lstlisting}{\numberline {5.16}OMG HUTN for people with mothers and fathers.}{127}{lstlisting.5.16}
\contentsline {lstlisting}{\numberline {5.17}HUTN for people with parents.}{129}{lstlisting.5.17}
\contentsline {lstlisting}{\numberline {5.18}Part of the Petri nets migration in ATL}{131}{lstlisting.5.18}
\contentsline {lstlisting}{\numberline {5.19}Java method for deserialising a reference.}{134}{lstlisting.5.19}
\contentsline {lstlisting}{\numberline {5.20}Petri nets model migration in COPE}{137}{lstlisting.5.20}
