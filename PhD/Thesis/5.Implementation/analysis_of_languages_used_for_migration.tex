...
This section uses the Petri net metamodel evolution to compare model migration languages. The example is often used in co-evolution literature, such as in \cite{cicchetti08automating,garces09managing,wachsmuth07metamodel}.
