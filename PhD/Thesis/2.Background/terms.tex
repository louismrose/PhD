...
\begin{lstlisting}[caption={[Exemplar M2M transformation in ETL]Exemplar M2M transformation in the Epsilon Transformation Language \cite{kolovos08etl}}, label=lst:exemplar_m2m, language=ETL]
...
\begin{lstlisting}[caption={[Exemplar M2T transformation in EGL]Exemplar M2T transformation in the Epsilon Generation Language \cite{rose08egl}}, label=lst:exemplar_m2t, language=EGL]
