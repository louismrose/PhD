...
public class MovefeatureFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "movefeature";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/refactorings.movefeature/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/refactorings.movefeature/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new MovefeatureResourceHandler());
	...
	private ExtendedMetaData getExtendedMetaData() {
		if(extendedMetaData == null) {
			...
			ePackageRegistry.put(BEFORE_NS_URI,      MovefeaturePackage.eINSTANCE);
			ePackageRegistry.put(AFTER_PLATFORM_URI, MovefeaturePackage.eINSTANCE);
