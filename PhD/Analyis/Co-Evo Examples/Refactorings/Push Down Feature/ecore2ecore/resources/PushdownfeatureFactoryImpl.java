...
public class PushdownfeatureFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "pushdownfeature";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/refactorings.pushdownfeature/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/refactorings.pushdownfeature/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new PushdownfeatureResourceHandler());
	...
	private ExtendedMetaData getExtendedMetaData() {
		if(extendedMetaData == null) {
			...
			ePackageRegistry.put(BEFORE_NS_URI,      PushdownfeaturePackage.eINSTANCE);
			ePackageRegistry.put(AFTER_PLATFORM_URI, PushdownfeaturePackage.eINSTANCE);
