...
public class PartitioncontainmentFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "partitioncontainment";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/gadin.partitioncontainment/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/gadin.partitioncontainment/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new PartitioncontainmentResourceHandler());
