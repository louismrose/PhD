...
<asm name="0">
	<cp>
		...
		<constant value="20:16-20:33"/>
		<constant value="20:16-20:42"/>
		<constant value="20:4-20:42"/>
		<constant value="21:14-21:15"/>
		<constant value="21:14-21:31"/>
		<constant value="21:14-21:38"/>
		<constant value="21:4-21:38"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	<operation name="5">
	...
	<operation name="77">
		...
		<linenumbertable>
			...
			<lne id="84" begin="17" end="17"/>
			<lne id="85" begin="17" end="18"/>
			<lne id="86" begin="17" end="19"/>
			<lne id="87" begin="15" end="21"/>
			<lne id="88" begin="24" end="24"/>
			<lne id="89" begin="24" end="25"/>
			<lne id="90" begin="24" end="26"/>
			<lne id="91" begin="22" end="28"/>
			<lne id="76" begin="8" end="29"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="57" begin="7" end="29"/>
			<lve slot="2" name="55" begin="3" end="29"/>
			<lve slot="0" name="17" begin="0" end="29"/>
			<lve slot="1" name="72" begin="0" end="29"/>
		</localvariabletable>
	</operation>
</asm>
