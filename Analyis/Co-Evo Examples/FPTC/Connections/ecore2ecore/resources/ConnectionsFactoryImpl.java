...
public class ConnectionsFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "connections";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/fptc.connections/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/fptc.connections/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new ConnectionsResourceHandler());
	...
	private ExtendedMetaData getExtendedMetaData() {
		if(extendedMetaData == null) {
			...
			ePackageRegistry.put(BEFORE_NS_URI,      ConnectionsPackage.eINSTANCE);
			ePackageRegistry.put(AFTER_PLATFORM_URI, ConnectionsPackage.eINSTANCE);
