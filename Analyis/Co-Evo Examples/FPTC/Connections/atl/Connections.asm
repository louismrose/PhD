...
<asm name="0">
	<cp>
		...
		<constant value="link"/>
		<constant value="__matchBlocks"/>
		<constant value="Block"/>
		<constant value="18:7-18:18"/>
		<constant value="18:3-21:4"/>
		<constant value="__applyBlocks"/>
		<constant value="successors"/>
		<constant value="4"/>
		<constant value="J.Connections(JJ):J"/>
		<constant value="CJ.including(J):CJ"/>
		<constant value="outgoingConnections"/>
		...
		<constant value="20:53-20:63"/>
		<constant value="20:76-20:77"/>
		<constant value="20:78-20:79"/>
		<constant value="20:53-20:80"/>
		<constant value="20:27-20:81"/>
		<constant value="20:4-20:81"/>
		<constant value="s"/>
		<constant value="MBefore!Block;"/>
		<constant value="t"/>
		<constant value="c"/>
		...
		<constant value="31:4-31:15"/>
		<constant value="29:3-32:4"/>
		<constant value="34:3-34:15"/>
		<constant value="34:3-34:30"/>
		<constant value="34:3-34:39"/>
		<constant value="34:55-34:56"/>
		<constant value="34:3-34:57"/>
	...
	<operation name="77">
		...
		<linenumbertable>
			...
			<lne id="86" begin="20" end="20"/>
			<lne id="87" begin="20" end="21"/>
			<lne id="88" begin="24" end="24"/>
			<lne id="89" begin="25" end="25"/>
			<lne id="90" begin="26" end="26"/>
			<lne id="91" begin="24" end="27"/>
			<lne id="92" begin="17" end="29"/>
			<lne id="93" begin="15" end="31"/>
			<lne id="76" begin="8" end="32"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="4" name="94" begin="23" end="28"/>
			<lve slot="3" name="57" begin="7" end="32"/>
			<lve slot="2" name="55" begin="3" end="32"/>
			<lve slot="0" name="17" begin="0" end="32"/>
			<lve slot="1" name="72" begin="0" end="32"/>
		</localvariabletable>
	</operation>
	<operation name="0">
		<context type="6"/>
		...
		<linenumbertable>
			...
			<lne id="105" begin="27" end="31"/>
			<lne id="106" begin="34" end="34"/>
			<lne id="107" begin="32" end="36"/>
			<lne id="108" begin="26" end="37"/>
			<lne id="109" begin="38" end="40"/>
			<lne id="110" begin="38" end="41"/>
			<lne id="111" begin="38" end="42"/>
			<lne id="112" begin="43" end="43"/>
			<lne id="113" begin="38" end="44"/>
			<lne id="114" begin="38" end="44"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="97" begin="22" end="45"/>
			<lve slot="0" name="17" begin="0" end="45"/>
			<lve slot="1" name="94" begin="0" end="45"/>
			<lve slot="2" name="96" begin="0" end="45"/>
		</localvariabletable>
	</operation>
</asm>
