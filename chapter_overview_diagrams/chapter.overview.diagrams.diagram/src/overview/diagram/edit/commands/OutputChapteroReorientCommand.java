 ...
 * @generated
 */
public class OutputChapteroReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputChapteroReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Chapter && newEnd instanceof Output)) {
			return false;
		}
		return OverviewBaseItemSemanticEditPolicy.LinkConstraints
				.canExistOutputChaptero_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return OverviewBaseItemSemanticEditPolicy.LinkConstraints
				.canExistOutputChaptero_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setChaptero(null);
		getNewSource().setChaptero(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setChaptero(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
