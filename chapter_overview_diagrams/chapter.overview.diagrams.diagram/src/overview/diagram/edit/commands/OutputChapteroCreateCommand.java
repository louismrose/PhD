 ...
 * @generated
 */
public class OutputChapteroCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputChapteroCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Chapter) {
			return false;
		}
		if (getSource() == null) {
		...
		return OverviewBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateOutputChaptero_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setChaptero(getTarget());
		}
