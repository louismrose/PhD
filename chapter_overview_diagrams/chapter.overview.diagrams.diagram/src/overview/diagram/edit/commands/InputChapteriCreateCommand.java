 ...
 * @generated
 */
public class InputChapteriCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InputChapteriCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OverviewBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateInputChapteri_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setChapteri(getTarget());
		}
