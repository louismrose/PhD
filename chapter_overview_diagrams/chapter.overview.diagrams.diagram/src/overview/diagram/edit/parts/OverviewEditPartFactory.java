 ...
 * @generated
 */
public class OverviewEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case OverviewEditPart.VISUAL_ID:
				return new OverviewEditPart(view);

			case ChapterEditPart.VISUAL_ID:
				return new ChapterEditPart(view);

			case ChapterNameEditPart.VISUAL_ID:
				return new ChapterNameEditPart(view);
			...
			case InputChapteriEditPart.VISUAL_ID:
				return new InputChapteriEditPart(view);

			case WrappingLabelEditPart.VISUAL_ID:
				return new WrappingLabelEditPart(view);

			case OutputChapteroEditPart.VISUAL_ID:
				return new OutputChapteroEditPart(view);
