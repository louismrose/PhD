...
import overview.diagram.edit.policies.InputItemSemanticEditPolicy;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		InputFigure figure = new InputFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputNameEditPart) {
			((InputNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (targetEditPart instanceof ChapterEditPart) {
			types.add(OverviewElementTypes.InputChapteri_4001);
		}
		return types;
	}
	...
	public class InputFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureInputLabelFigure.setFont(FFIGUREINPUTLABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREINPUTLABELFIGURE_FONT = new Font(Display
			.getCurrent(), "Gills Sans", 13, SWT.NORMAL);
