...
import overview.diagram.edit.policies.OutputItemSemanticEditPolicy;
...
public class OutputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutputItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OutputNameEditPart) {
			((OutputNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public class OutputFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureOutputLabelFigure.setFont(FFIGUREOUTPUTLABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREOUTPUTLABELFIGURE_FONT = new Font(Display
