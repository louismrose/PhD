 ...
 * @generated
 */
public class OverviewElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public OverviewElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.OverviewElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "overview".equals(fileExtension); //$NON-NLS-1$
	}
