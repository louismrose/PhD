...
import overview.diagram.part.OverviewDiagramEditor;
 ...
 * @generated
 */
public class OverviewNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof OverviewNavigatorItem) {
					selectedElement = ((OverviewNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (OverviewEditPart.MODEL_ID
							.equals(OverviewVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, OverviewDiagramEditor.ID);
