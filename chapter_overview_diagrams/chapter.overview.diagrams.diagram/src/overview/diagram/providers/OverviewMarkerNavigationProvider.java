...
import overview.diagram.part.OverviewDiagramEditorUtil;

/**
 * @generated
 */
public class OverviewMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = OverviewDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			OverviewDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
