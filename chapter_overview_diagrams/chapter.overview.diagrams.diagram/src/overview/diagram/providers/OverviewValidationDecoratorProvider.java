 ...
 * @generated
 */
public class OverviewValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = OverviewDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof OverviewDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& OverviewEditPart.MODEL_ID.equals(OverviewVisualIDRegistry
						.getModelID(view));
	}
