...
public class InlineclassFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "inlineclass";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/refactorings.inlineclass/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/refactorings.inlineclass/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new InlineclassResourceHandler());
	...
	private ExtendedMetaData getExtendedMetaData() {
		if(extendedMetaData == null) {
			...
			ePackageRegistry.put(BEFORE_NS_URI,      InlineclassPackage.eINSTANCE);
			ePackageRegistry.put(AFTER_PLATFORM_URI, InlineclassPackage.eINSTANCE);
