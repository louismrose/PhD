...
public class Cont2refFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "cont2ref";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/refactorings.cont2ref/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/refactorings.cont2ref/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new Cont2refResourceHandler());
	...
	private ExtendedMetaData getExtendedMetaData() {
		if(extendedMetaData == null) {
			...
			ePackageRegistry.put(BEFORE_NS_URI,      Cont2refPackage.eINSTANCE);
			ePackageRegistry.put(AFTER_PLATFORM_URI, Cont2refPackage.eINSTANCE);
