...
public class ExtractsubclassFactoryImpl extends XMIResourceFactoryImpl {

	public static final String BEFORE_NS_URI       = "extractsubclass";
	public static final String AFTER_PLATFORM_URI  = "platform:/plugin/refactorings.extractsubclass/model/After.ecore";
	public static final String BEFORE_PLATFORM_URI = "platform:/plugin/refactorings.extractsubclass/model/Before_2_After.ecore2xml";
	...
	public Resource createResource(URI uri) {
		...
		defaultLoadOptions.put(XMLResource.OPTION_RESOURCE_HANDLER,       new ExtractsubclassResourceHandler());
	...
	private ExtendedMetaData getExtendedMetaData() {
		if(extendedMetaData == null) {
			...
			ePackageRegistry.put(BEFORE_NS_URI,      ExtractsubclassPackage.eINSTANCE);
			ePackageRegistry.put(AFTER_PLATFORM_URI, ExtractsubclassPackage.eINSTANCE);
