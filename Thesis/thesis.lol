...
\contentsline {lstlisting}{\numberline {5.2}Consistency constraint for instantiating a metamodel type}{107}{lstlisting.5.2}
...
\contentsline {lstlisting}{\numberline {5.13}Consistency constraint for checking the uniqueness of identifiers}{120}{lstlisting.5.13}
...
\contentsline {lstlisting}{\numberline {5.25}Using a non-null check to guard a migration rule}{146}{lstlisting.5.25}
\contentsline {lstlisting}{\numberline {5.26}Using primitive and collection values}{147}{lstlisting.5.26}
\contentsline {lstlisting}{\numberline {5.27}Using higher-order operations on collections}{147}{lstlisting.5.27}
\contentsline {lstlisting}{\numberline {5.28}Using metamodel types}{148}{lstlisting.5.28}
\contentsline {lstlisting}{\numberline {5.29}Creating new model elements}{149}{lstlisting.5.29}
\contentsline {lstlisting}{\numberline {5.30}Using a context-less custom operation}{150}{lstlisting.5.30}
\contentsline {lstlisting}{\numberline {5.31}Using a custom operation in the context of a metamodel type}{150}{lstlisting.5.31}
\contentsline {lstlisting}{\numberline {5.32}Prompting for user input at runtime}{151}{lstlisting.5.32}
\contentsline {lstlisting}{\numberline {5.33}Changing and unsetting conservatively copied feature values}{152}{lstlisting.5.33}
\contentsline {lstlisting}{\numberline {5.34}Casting feature values}{153}{lstlisting.5.34}
\contentsline {lstlisting}{\numberline {5.35}Using \texttt {equivalent()} to access migrated model elements}{153}{lstlisting.5.35}
\contentsline {lstlisting}{\numberline {5.36}Preventing the conservative copy of original model elements}{154}{lstlisting.5.36}
\contentsline {lstlisting}{\numberline {5.37}Redefining equivalences for the Component model migration.}{154}{lstlisting.5.37}
\contentsline {lstlisting}{\numberline {5.38}A migration strategy for the evolution in Figure\nobreakspace {}\ref {fig:inheritance}}{156}{lstlisting.5.38}
\contentsline {lstlisting}{\numberline {5.39}Using an operation to reduce the duplication in Listing\nobreakspace {}\ref {lst:rule_order_considerations}}{157}{lstlisting.5.39}
...
\contentsline {lstlisting}{\numberline {A.5}Generating the intermediate to target model transformation}{260}{lstlisting.A.5}
...
\contentsline {lstlisting}{\numberline {C.1}The Newsgroup Extract Person migration in ATL}{280}{lstlisting.C.1}
\contentsline {lstlisting}{\numberline {C.2}The Newsgroup Extract Person migration in Groovy-for-COPE}{281}{lstlisting.C.2}
\contentsline {lstlisting}{\numberline {C.3}The Newsgroup Extract Person migration in Flock}{281}{lstlisting.C.3}
\contentsline {lstlisting}{\numberline {C.4}The Newsgroup Resolve Replies migration in ATL}{282}{lstlisting.C.4}
\contentsline {lstlisting}{\numberline {C.5}The Newsgroup Resolve Replies migration in Groovy-for-COPE}{283}{lstlisting.C.5}
\contentsline {lstlisting}{\numberline {C.6}The Newsgroup Resolve Replies migration in Flock}{283}{lstlisting.C.6}
\contentsline {lstlisting}{\numberline {C.7}UML activity diagram migration in ATL}{284}{lstlisting.C.7}
\contentsline {lstlisting}{\numberline {C.8}UML activity diagram migration in Groovy-for-COPE}{288}{lstlisting.C.8}
\contentsline {lstlisting}{\numberline {C.9}UML activity diagram migration in Flock}{289}{lstlisting.C.9}
\contentsline {lstlisting}{\numberline {C.10}GMF Graph migration in ATL}{291}{lstlisting.C.10}
\contentsline {lstlisting}{\numberline {C.11}GMF Graph migration in Groovy-for-COPE}{303}{lstlisting.C.11}
\contentsline {lstlisting}{\numberline {C.12}GMF Graph migration in Flock}{304}{lstlisting.C.12}
\contentsline {lstlisting}{\numberline {C.13}GMF Generator migration in ATL}{305}{lstlisting.C.13}
\contentsline {lstlisting}{\numberline {C.14}GMF Generator migration in Groovy-for-COPE}{330}{lstlisting.C.14}
\contentsline {lstlisting}{\numberline {C.15}GMF Generator migration in Flock}{332}{lstlisting.C.15}
