...
public class NegativeProposition extends AcceptanceTest {

	
	@BeforeClass
	public static void setup() throws Exception {
		acceptanceTest("unfancy"              + '\n' +
 		               "  involves"           + '\n' +
		               "    c - Character"    + '\n' +
		               "    d - Character"    + '\n' +
		               "  then "              + '\n' +
	...
	@Test
	public void actionIsNamedUnfancy() {
		model.assertEquals("unfancy", "action.name");
	}
	...
	@Test
	public void effectHasTypeWithNameFancy() {
		model.assertEquals("fancy", "effect.type.name");
	}
	
	@Test
	public void effectIsNegative() {
		model.assertFalse("effect.positive");
	}
